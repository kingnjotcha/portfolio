...
const projectsData = [
  ...
  {
    title: 'Unima LAW Cypher 2024',
    description: 'Official unima law cypher 2024  .',
    technologies: ['Adobe Premier', 'Photoshop'],
    github: 'https://github.com/your-github/adventure-game',
    demo: 'https://www.youtube.com/watch?v=BLYSoMYsi6U',
    ...
    return (
      <div className="projs-section">
        <div className="projects-container container mt-5">
          ...
          <p className="projects-subtitle text-center lead">
            These are some of the major projects I have completed so far. Each project demonstrates my skills in various technologies and showcases my development experience.
          </p>
                  ...
                  <div className="card-body">
                    ...
                    {project.demo && (
                      <a 
                        ...
                        style={{ zIndex: 10, position: 'relative' }} // Ensure the button is clickable
                      >
                        View
                      </a>
                    )}
